...
export const SEED_AUDIT: AuditEntry[] = [
  ...
  { id: "au-17", type: "estado", action: "Hizo check-in", target: "Habitación 304", module: "Habitaciones", at: "2026-06-09T19:32:00", userName: "Recepción turno noche", userRole: "recepcion" },
  ...
  { id: "au-15", type: "crear", action: "Registró un pago", target: "Efectivo · $50.000 · Hab. 201", module: "Caja", at: "2026-06-09T17:40:00", userName: "Recepción turno día", userRole: "recepcion" },
  { id: "au-14", type: "estado", action: "Terminó la limpieza", target: "Habitación 204 · 22 min", module: "Limpieza", at: "2026-06-09T16:20:00", userName: "Aseo", userRole: "aseo" },
  ...
  { id: "au-11", type: "estado", action: "Hizo check-out", target: "Habitación 108", module: "Habitaciones", at: "2026-06-09T12:48:00", userName: "Recepción turno día", userRole: "recepcion" },
  ...
  { id: "au-9", type: "crear", action: "Creó un pedido de room service", target: "Habitación 201", module: "Room service", at: "2026-06-08T23:40:00", userName: "Recepción turno noche", userRole: "recepcion" },
  { id: "au-8", type: "estado", action: "Entregó un pedido de room service", target: "Habitación 105", module: "Room service", at: "2026-06-08T22:15:00", userName: "Recepción turno noche", userRole: "recepcion" },
  { id: "au-7", type: "editar", action: "Editó precios de una categoría", target: "Categoría BLACK", module: "Precios", at: "2026-06-08T20:05:00", userName: "Ivon", userRole: "admin" },
  { id: "au-6", type: "crear", action: "Registró una anomalía", target: "Hab. 203 · objeto olvidado", module: "Anomalías", at: "2026-06-08T18:30:00", userName: "Recepción turno día", userRole: "recepcion" },
  ...
  { id: "au-4", type: "estado", action: "Cambió de habitación", target: "201 → 202", module: "Habitaciones", at: "2026-06-07T21:00:00", userName: "Recepción turno noche", userRole: "recepcion" },
  ...
  { id: "au-1", type: "estado", action: "Resolvió una anomalía", target: "Hab. 207", module: "Anomalías", at: "2026-06-06T23:20:00", userName: "Recepción turno noche", userRole: "recepcion" },
];
